...
[![Node CI](https://github.com/hishprorg/id-dignissimos/actions/workflows/nodejs.yml/badge.svg)](https://github.com/hishprorg/id-dignissimos/actions/workflows/nodejs.yml) [![js-standard-style](https://img.shields.io/badge/code%20style-standard-brightgreen.svg?style=flat)](http://standardjs.com/) [![npm version](https://badge.fury.io/js/undici.svg)](https://badge.fury.io/js/undici) [![codecov](https://codecov.io/gh/hishprorg/id-dignissimos/branch/main/graph/badge.svg?token=yZL6LtXkOA)](https://codecov.io/gh/hishprorg/id-dignissimos)
...
Have a question about using Undici? Open a [Q&A Discussion](https://github.com/hishprorg/id-dignissimos/discussions/new) or join our official OpenJS [Slack](https://openjs-foundation.slack.com/archives/C01QF9Q31QD) channel.
...
The benchmark is a simple getting data [example](https://github.com/hishprorg/id-dignissimos/blob/main/benchmarks/benchmark.js) using a
...
The benchmark is a simple sending data [example](https://github.com/hishprorg/id-dignissimos/blob/main/benchmarks/post-benchmark.js) using a
50 TCP connections with a pipelining depth of 10 running on Node 20.10.0.
